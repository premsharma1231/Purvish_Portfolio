...
function Projectcard({title, description, GithubUrl, LiveUrl, urlToImage, languageUsed }) {
  ...
  return (
    <>
    <Tilt className="card ml-14 flex flex-row justify-between items-center w-11/12 h-full p-2 bg-gray-300 text-center font-Karla border-none shadow" perspective={2000} glareEnable={true} tiltMaxAngleX={5} tiltMaxAngleY={5} glareMaxOpacity={0}>
    <div className="flex">
      <img src={urlToImage} className="card-img-top w-3/6" alt={title} />
