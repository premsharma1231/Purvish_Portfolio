...
const Cursor = () => {
    ...
    return (
        <>
            ...
            <div
                className={`fixed w-2 h-2 p-4 ${isClicked ? "p-5" : "p-4"} z-50 border-none opacity-65 bg-black rounded-full pointer-events-none transition-all duration-0 ease-out`}
                style={{
