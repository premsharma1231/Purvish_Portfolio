...
function Education(){
  return(
    <>
    <div className="flex w-11/12 pb-14">
    <div className="w-6/12 mt-20 mx-3 p-6 pl-16 pt-20 bg-white text-DarkColor rounded-md font-Karla font-bold relative">
    ...
    <div className="w-6/12 mt-20 mx-3 p-6 pl-16 pt-20 bg-gray-300 rounded-md font-Karla font-bold relative">
