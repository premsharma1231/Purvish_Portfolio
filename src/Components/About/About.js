...
function About(){
  ...
  return(
    ...
    <div className="flex flex-wrap justify-center items-center mt-4 mb-12">
        ...
        <FontAwesomeIcon bounce icon={faHtml5} className="w-20 h-20"/>
        HTML 5
        </span>
        <span className="flex flex-col text-center justify-center font-Bungee items-center mx-5">
        <FontAwesomeIcon bounce icon={faCss} className="w-20 h-20"/>
        CSS
        </span>
        <span className="flex flex-col text-center justify-center font-Bungee items-center mx-5">
        <FontAwesomeIcon bounce icon={faJs} className="w-20 h-20"/>
        JavaScript
        </span>
        <span className="flex flex-col text-center justify-center font-Bungee items-center mx-5">
        <FontAwesomeIcon bounce icon={faReact} className="w-20 h-20"/>
        React JS
        </span>
        <span className="flex flex-col text-center justify-center font-Bungee items-center mx-5">
        <FontAwesomeIcon bounce icon={faBootstrap} className="w-20 h-20"/>
        BootStrap 5
        </span>
        <span className="flex flex-col text-center justify-center font-Bungee items-center mx-5">
